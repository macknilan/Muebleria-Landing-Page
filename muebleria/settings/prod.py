...
ALLOWED_HOSTS = ['206.189.175.71', 'localhost', '0.0.0.0']
...
STATIC_URL = '{}/{}/{}/'.format(AWS_S3_ENDPOINT_URL, AWS_LOCATION, STATICFILES_LOCATION)
STATICFILES_STORAGE = 'custom_storages.StaticStorage'

MEDIAFILES_LOCATION = 'media'
MEDIA_URL = '{}/{}/{}/'.format(AWS_S3_ENDPOINT_URL, AWS_LOCATION, MEDIAFILES_LOCATION)
